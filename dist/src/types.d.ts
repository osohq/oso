 ...
 * @internal
 */
export declare type PolarValue = PolarStr | PolarNum | PolarBool | PolarList | PolarDict | PolarPredicate | PolarVariable | PolarInstance | PolarExpression | PolarPattern;
/**
 * Union of Polar value types.
 *
 * @internal
 ...
 * @internal
 */
export declare function isPolarTerm(v: unknown): v is PolarTerm;
/**
 ...
 */
export declare type QueryResult = AsyncGenerator<Map<string, unknown>, void, undefined | void>;
/**
 ...
 */
export declare type EqualityFn = (x: unknown, y: unknown) => boolean;
export declare type CustomError = new (...args: any[]) => Error;
/**
 ...
 * @internal
 */
export declare function isIterableIterator(x: unknown): x is IterableIterator<unknown>;
/**
 ...
 * @internal
 */
export declare function isAsyncIterable(x: unknown): x is AsyncIterable<unknown>;
/**
...
export declare type IsaCheck = (instance: NullishOrHasConstructor) => boolean;
/**
 ...
 */
export declare type NullishOrHasConstructor = {
    constructor: Class;
} | null | undefined;
export declare type HostTypes = Map<string | Class, UserType<any>>;
export declare class UserType<Type extends Class<T>, T = any> {
    name: string;
    cls: Type;
    id: number;
    fields: Map<string, Class | Relation>;
