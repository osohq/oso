...
export function query_callResult(a: number, b: number, c: number): void;
...
export function query_bind(a: number, b: number, c: number, d: number): void;
...
export function polar_load(a: number, b: number): void;
...
export function polar_registerMro(a: number, b: number, c: number, d: number): void;
export function polar_buildDataFilter(a: number, b: number, c: number, d: number, e: number, f: number, g: number): number;
