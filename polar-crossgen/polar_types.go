...
func (obj *Call) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_Term(obj.Args, serializer); err != nil { return err }
	if err := serialize_option_map_Symbol_to_Term(obj.Kwargs, serializer); err != nil { return err }
...
func DeserializeCall(deserializer serde.Deserializer) (Call, error) {
	...
	if val, err := DeserializeSymbol(deserializer); err == nil { obj.Name = val } else { return obj, err }
	if val, err := deserialize_vector_Term(deserializer); err == nil { obj.Args = val } else { return obj, err }
	if val, err := deserialize_option_map_Symbol_to_Term(deserializer); err == nil { obj.Kwargs = val } else { return obj, err }
...
func (obj *Dictionary) Serialize(serializer serde.Serializer) error {
	if err := serializer.IncreaseContainerDepth(); err != nil { return err }
	if err := serialize_map_Symbol_to_Term(obj.Fields, serializer); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func DeserializeDictionary(deserializer serde.Deserializer) (Dictionary, error) {
	var obj Dictionary
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := deserialize_map_Symbol_to_Term(deserializer); err == nil { obj.Fields = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func (obj *ExternalInstance) Serialize(serializer serde.Serializer) error {
	if err := serializer.IncreaseContainerDepth(); err != nil { return err }
	if err := serializer.SerializeU64(obj.InstanceId); err != nil { return err }
	if err := serialize_option_Term(obj.Constructor, serializer); err != nil { return err }
	if err := serialize_option_str(obj.Repr, serializer); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func DeserializeExternalInstance(deserializer serde.Deserializer) (ExternalInstance, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := deserializer.DeserializeU64(); err == nil { obj.InstanceId = val } else { return obj, err }
	if val, err := deserialize_option_Term(deserializer); err == nil { obj.Constructor = val } else { return obj, err }
	if val, err := deserialize_option_str(deserializer); err == nil { obj.Repr = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func (obj *InstanceLiteral) Serialize(serializer serde.Serializer) error {
	if err := serializer.IncreaseContainerDepth(); err != nil { return err }
	if err := obj.Tag.Serialize(serializer); err != nil { return err }
	if err := obj.Fields.Serialize(serializer); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func DeserializeInstanceLiteral(deserializer serde.Deserializer) (InstanceLiteral, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := DeserializeSymbol(deserializer); err == nil { obj.Tag = val } else { return obj, err }
	if val, err := DeserializeDictionary(deserializer); err == nil { obj.Fields = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func load_Node__Rule(deserializer serde.Deserializer) (Node__Rule, error) {
	var obj Node__Rule
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := DeserializeRule(deserializer); err == nil { obj.Value = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func load_Node__Term(deserializer serde.Deserializer) (Node__Term, error) {
	var obj Node__Term
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := DeserializeTerm(deserializer); err == nil { obj.Value = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func (obj *Numeric__Integer) Serialize(serializer serde.Serializer) error {
	if err := serializer.IncreaseContainerDepth(); err != nil { return err }
	serializer.SerializeVariantIndex(0)
	if err := serializer.SerializeI64(((int64)(*obj))); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func load_Numeric__Integer(deserializer serde.Deserializer) (Numeric__Integer, error) {
	var obj int64
	if err := deserializer.IncreaseContainerDepth(); err != nil { return (Numeric__Integer)(obj), err }
	if val, err := deserializer.DeserializeI64(); err == nil { obj = val } else { return ((Numeric__Integer)(obj)), err }
	deserializer.DecreaseContainerDepth()
...
func (obj *Numeric__Float) Serialize(serializer serde.Serializer) error {
	if err := serializer.IncreaseContainerDepth(); err != nil { return err }
	serializer.SerializeVariantIndex(1)
	if err := serializer.SerializeF64(((float64)(*obj))); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func load_Numeric__Float(deserializer serde.Deserializer) (Numeric__Float, error) {
	var obj float64
	if err := deserializer.IncreaseContainerDepth(); err != nil { return (Numeric__Float)(obj), err }
	if val, err := deserializer.DeserializeF64(); err == nil { obj = val } else { return ((Numeric__Float)(obj)), err }
	deserializer.DecreaseContainerDepth()
...
func (obj *Operation) Serialize(serializer serde.Serializer) error {
	if err := serializer.IncreaseContainerDepth(); err != nil { return err }
	if err := obj.Operator.Serialize(serializer); err != nil { return err }
	if err := serialize_vector_Term(obj.Args, serializer); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func DeserializeOperation(deserializer serde.Deserializer) (Operation, error) {
	var obj Operation
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := DeserializeOperator(deserializer); err == nil { obj.Operator = val } else { return obj, err }
	if val, err := deserialize_vector_Term(deserializer); err == nil { obj.Args = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func (obj *Parameter) Serialize(serializer serde.Serializer) error {
	if err := serializer.IncreaseContainerDepth(); err != nil { return err }
	if err := obj.Parameter.Serialize(serializer); err != nil { return err }
	if err := serialize_option_Term(obj.Specializer, serializer); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func DeserializeParameter(deserializer serde.Deserializer) (Parameter, error) {
	var obj Parameter
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := DeserializeTerm(deserializer); err == nil { obj.Parameter = val } else { return obj, err }
	if val, err := deserialize_option_Term(deserializer); err == nil { obj.Specializer = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func (obj *Partial) Serialize(serializer serde.Serializer) error {
	if err := serializer.IncreaseContainerDepth(); err != nil { return err }
	if err := serialize_vector_Operation(obj.Constraints, serializer); err != nil { return err }
	if err := obj.Variable.Serialize(serializer); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func DeserializePartial(deserializer serde.Deserializer) (Partial, error) {
	var obj Partial
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := deserialize_vector_Operation(deserializer); err == nil { obj.Constraints = val } else { return obj, err }
	if val, err := DeserializeSymbol(deserializer); err == nil { obj.Variable = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func load_Pattern__Dictionary(deserializer serde.Deserializer) (Pattern__Dictionary, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := DeserializeDictionary(deserializer); err == nil { obj.Value = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func load_Pattern__Instance(deserializer serde.Deserializer) (Pattern__Instance, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := DeserializeInstanceLiteral(deserializer); err == nil { obj.Value = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func (obj *QueryEvent__Done) Serialize(serializer serde.Serializer) error {
	if err := serializer.IncreaseContainerDepth(); err != nil { return err }
	serializer.SerializeVariantIndex(1)
	if err := serializer.SerializeBool(obj.Result); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func load_QueryEvent__Done(deserializer serde.Deserializer) (QueryEvent__Done, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := deserializer.DeserializeBool(); err == nil { obj.Result = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func (obj *QueryEvent__Debug) Serialize(serializer serde.Serializer) error {
	if err := serializer.IncreaseContainerDepth(); err != nil { return err }
	serializer.SerializeVariantIndex(2)
	if err := serializer.SerializeStr(obj.Message); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func load_QueryEvent__Debug(deserializer serde.Deserializer) (QueryEvent__Debug, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := deserializer.DeserializeStr(); err == nil { obj.Message = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func (obj *QueryEvent__MakeExternal) Serialize(serializer serde.Serializer) error {
	...
	serializer.SerializeVariantIndex(3)
	if err := serializer.SerializeU64(obj.InstanceId); err != nil { return err }
	if err := obj.Constructor.Serialize(serializer); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func load_QueryEvent__MakeExternal(deserializer serde.Deserializer) (QueryEvent__MakeExternal, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := deserializer.DeserializeU64(); err == nil { obj.InstanceId = val } else { return obj, err }
	if val, err := DeserializeTerm(deserializer); err == nil { obj.Constructor = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func (obj *QueryEvent__ExternalCall) Serialize(serializer serde.Serializer) error {
	if err := serializer.IncreaseContainerDepth(); err != nil { return err }
	serializer.SerializeVariantIndex(4)
	if err := serializer.SerializeU64(obj.CallId); err != nil { return err }
	if err := obj.Instance.Serialize(serializer); err != nil { return err }
	if err := obj.Attribute.Serialize(serializer); err != nil { return err }
	if err := serialize_option_vector_Term(obj.Args, serializer); err != nil { return err }
	if err := serialize_option_map_Symbol_to_Term(obj.Kwargs, serializer); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func load_QueryEvent__ExternalCall(deserializer serde.Deserializer) (QueryEvent__ExternalCall, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := deserializer.DeserializeU64(); err == nil { obj.CallId = val } else { return obj, err }
	if val, err := DeserializeTerm(deserializer); err == nil { obj.Instance = val } else { return obj, err }
	if val, err := DeserializeSymbol(deserializer); err == nil { obj.Attribute = val } else { return obj, err }
	if val, err := deserialize_option_vector_Term(deserializer); err == nil { obj.Args = val } else { return obj, err }
	if val, err := deserialize_option_map_Symbol_to_Term(deserializer); err == nil { obj.Kwargs = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func (obj *QueryEvent__ExternalIsa) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeU64(obj.CallId); err != nil { return err }
	if err := obj.Instance.Serialize(serializer); err != nil { return err }
	if err := obj.ClassTag.Serialize(serializer); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func load_QueryEvent__ExternalIsa(deserializer serde.Deserializer) (QueryEvent__ExternalIsa, error) {
	...
	if val, err := deserializer.DeserializeU64(); err == nil { obj.CallId = val } else { return obj, err }
	if val, err := DeserializeTerm(deserializer); err == nil { obj.Instance = val } else { return obj, err }
	if val, err := DeserializeSymbol(deserializer); err == nil { obj.ClassTag = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func (obj *QueryEvent__ExternalIsSubSpecializer) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeU64(obj.CallId); err != nil { return err }
	if err := serializer.SerializeU64(obj.InstanceId); err != nil { return err }
	if err := obj.LeftClassTag.Serialize(serializer); err != nil { return err }
	if err := obj.RightClassTag.Serialize(serializer); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func load_QueryEvent__ExternalIsSubSpecializer(deserializer serde.Deserializer) (QueryEvent__ExternalIsSubSpecializer, error) {
	...
	if val, err := deserializer.DeserializeU64(); err == nil { obj.CallId = val } else { return obj, err }
	if val, err := deserializer.DeserializeU64(); err == nil { obj.InstanceId = val } else { return obj, err }
	if val, err := DeserializeSymbol(deserializer); err == nil { obj.LeftClassTag = val } else { return obj, err }
	if val, err := DeserializeSymbol(deserializer); err == nil { obj.RightClassTag = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func (obj *QueryEvent__ExternalUnify) Serialize(serializer serde.Serializer) error {
	...
	serializer.SerializeVariantIndex(8)
	if err := serializer.SerializeU64(obj.CallId); err != nil { return err }
	if err := serializer.SerializeU64(obj.LeftInstanceId); err != nil { return err }
	if err := serializer.SerializeU64(obj.RightInstanceId); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func load_QueryEvent__ExternalUnify(deserializer serde.Deserializer) (QueryEvent__ExternalUnify, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := deserializer.DeserializeU64(); err == nil { obj.CallId = val } else { return obj, err }
	if val, err := deserializer.DeserializeU64(); err == nil { obj.LeftInstanceId = val } else { return obj, err }
	if val, err := deserializer.DeserializeU64(); err == nil { obj.RightInstanceId = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func (obj *QueryEvent__Result) Serialize(serializer serde.Serializer) error {
	if err := serializer.IncreaseContainerDepth(); err != nil { return err }
	serializer.SerializeVariantIndex(9)
	if err := serialize_map_Symbol_to_Term(obj.Bindings, serializer); err != nil { return err }
	if err := serialize_option_TraceResult(obj.Trace, serializer); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func load_QueryEvent__Result(deserializer serde.Deserializer) (QueryEvent__Result, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := deserialize_map_Symbol_to_Term(deserializer); err == nil { obj.Bindings = val } else { return obj, err }
	if val, err := deserialize_option_TraceResult(deserializer); err == nil { obj.Trace = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func (obj *QueryEvent__NextExternal) Serialize(serializer serde.Serializer) error {
	...
	serializer.SerializeVariantIndex(11)
	if err := serializer.SerializeU64(obj.CallId); err != nil { return err }
	if err := obj.Iterable.Serialize(serializer); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func load_QueryEvent__NextExternal(deserializer serde.Deserializer) (QueryEvent__NextExternal, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := deserializer.DeserializeU64(); err == nil { obj.CallId = val } else { return obj, err }
	if val, err := DeserializeTerm(deserializer); err == nil { obj.Iterable = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func (obj *Rule) Serialize(serializer serde.Serializer) error {
	if err := serializer.IncreaseContainerDepth(); err != nil { return err }
	if err := obj.Name.Serialize(serializer); err != nil { return err }
	if err := serialize_vector_Parameter(obj.Params, serializer); err != nil { return err }
	if err := obj.Body.Serialize(serializer); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func DeserializeRule(deserializer serde.Deserializer) (Rule, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := DeserializeSymbol(deserializer); err == nil { obj.Name = val } else { return obj, err }
	if val, err := deserialize_vector_Parameter(deserializer); err == nil { obj.Params = val } else { return obj, err }
	if val, err := DeserializeTerm(deserializer); err == nil { obj.Body = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func (obj *Symbol) Serialize(serializer serde.Serializer) error {
	if err := serializer.IncreaseContainerDepth(); err != nil { return err }
...
func DeserializeSymbol(deserializer serde.Deserializer) (Symbol, error) {
	var obj string
	if err := deserializer.IncreaseContainerDepth(); err != nil { return (Symbol)(obj), err }
	if val, err := deserializer.DeserializeStr(); err == nil { obj = val } else { return ((Symbol)(obj)), err }
	deserializer.DecreaseContainerDepth()
	return (Symbol)(obj), nil
}
...
func (obj *Term) Serialize(serializer serde.Serializer) error {
	if err := serializer.IncreaseContainerDepth(); err != nil { return err }
	if err := obj.Value.Serialize(serializer); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeTerm(deserializer serde.Deserializer) (Term, error) {
	var obj Term
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := DeserializeValue(deserializer); err == nil { obj.Value = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func (obj *Trace) Serialize(serializer serde.Serializer) error {
	if err := serializer.IncreaseContainerDepth(); err != nil { return err }
	if err := obj.Node.Serialize(serializer); err != nil { return err }
	if err := serialize_vector_Trace(obj.Children, serializer); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func DeserializeTrace(deserializer serde.Deserializer) (Trace, error) {
	var obj Trace
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := DeserializeNode(deserializer); err == nil { obj.Node = val } else { return obj, err }
	if val, err := deserialize_vector_Trace(deserializer); err == nil { obj.Children = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func (obj *TraceResult) Serialize(serializer serde.Serializer) error {
	if err := serializer.IncreaseContainerDepth(); err != nil { return err }
	if err := obj.Trace.Serialize(serializer); err != nil { return err }
	if err := serializer.SerializeStr(obj.Formatted); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func DeserializeTraceResult(deserializer serde.Deserializer) (TraceResult, error) {
	var obj TraceResult
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := DeserializeTrace(deserializer); err == nil { obj.Trace = val } else { return obj, err }
	if val, err := deserializer.DeserializeStr(); err == nil { obj.Formatted = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func load_Value__Number(deserializer serde.Deserializer) (Value__Number, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := DeserializeNumeric(deserializer); err == nil { obj.Value = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func load_Value__String(deserializer serde.Deserializer) (Value__String, error) {
	var obj string
	if err := deserializer.IncreaseContainerDepth(); err != nil { return (Value__String)(obj), err }
	if val, err := deserializer.DeserializeStr(); err == nil { obj = val } else { return ((Value__String)(obj)), err }
	deserializer.DecreaseContainerDepth()
...
func load_Value__Boolean(deserializer serde.Deserializer) (Value__Boolean, error) {
	var obj bool
	if err := deserializer.IncreaseContainerDepth(); err != nil { return (Value__Boolean)(obj), err }
	if val, err := deserializer.DeserializeBool(); err == nil { obj = val } else { return ((Value__Boolean)(obj)), err }
	deserializer.DecreaseContainerDepth()
...
func load_Value__ExternalInstance(deserializer serde.Deserializer) (Value__ExternalInstance, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := DeserializeExternalInstance(deserializer); err == nil { obj.Value = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func load_Value__Pattern(deserializer serde.Deserializer) (Value__Pattern, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := DeserializePattern(deserializer); err == nil { obj.Value = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func load_Value__Call(deserializer serde.Deserializer) (Value__Call, error) {
	var obj Value__Call
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := DeserializeCall(deserializer); err == nil { obj.Value = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}

type Value__List []Term
...
func (obj *Value__List) Serialize(serializer serde.Serializer) error {
	if err := serializer.IncreaseContainerDepth(); err != nil { return err }
	serializer.SerializeVariantIndex(8)
	if err := serialize_vector_Term((([]Term)(*obj)), serializer); err != nil { return err }
	serializer.DecreaseContainerDepth()
	return nil
}
...
func load_Value__List(deserializer serde.Deserializer) (Value__List, error) {
	var obj []Term
	if err := deserializer.IncreaseContainerDepth(); err != nil { return (Value__List)(obj), err }
	if val, err := deserialize_vector_Term(deserializer); err == nil { obj = val } else { return ((Value__List)(obj)), err }
	deserializer.DecreaseContainerDepth()
	return (Value__List)(obj), nil
}

type Value__Variable struct {
	Value Symbol
}
...
func load_Value__Variable(deserializer serde.Deserializer) (Value__Variable, error) {
	var obj Value__Variable
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := DeserializeSymbol(deserializer); err == nil { obj.Value = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}

type Value__RestVariable struct {
	Value Symbol
}
...
func load_Value__Expression(deserializer serde.Deserializer) (Value__Expression, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := DeserializeOperation(deserializer); err == nil { obj.Value = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
...
func load_Value__Partial(deserializer serde.Deserializer) (Value__Partial, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil { return obj, err }
	if val, err := DeserializePartial(deserializer); err == nil { obj.Value = val } else { return obj, err }
	deserializer.DecreaseContainerDepth()
	return obj, nil
}
func serialize_map_Symbol_to_Term(value map[Symbol]Term, serializer serde.Serializer) error {
...
func deserialize_map_Symbol_to_Term(deserializer serde.Deserializer) (map[Symbol]Term, error) {
	length, err := deserializer.DeserializeLen()
	if err != nil { return nil, err }
	obj := make(map[Symbol]Term)
	previous_slice := serde.Slice { 0, 0 }
	for i := 0; i < int(length); i++ {
		var slice serde.Slice
		slice.Start = deserializer.GetBufferOffset()
		var key Symbol
		if val, err := DeserializeSymbol(deserializer); err == nil { key = val } else { return nil, err }
		...
		if val, err := DeserializeTerm(deserializer); err == nil { obj[key] = val } else { return nil, err }
	}
	return obj, nil
}

func serialize_option_Term(value *Term, serializer serde.Serializer) error {
	if value != nil {
...
func deserialize_option_Term(deserializer serde.Deserializer) (*Term, error) {
	tag, err := deserializer.DeserializeOptionTag()
	if err != nil { return nil, err }
	if tag {
		value := new(Term)
		if val, err := DeserializeTerm(deserializer); err == nil { *value = val } else { return nil, err }
	        return value, nil
	} else {
		return nil, nil
	}
...
func deserialize_option_TraceResult(deserializer serde.Deserializer) (*TraceResult, error) {
	...
	if tag {
		...
		if val, err := DeserializeTraceResult(deserializer); err == nil { *value = val } else { return nil, err }
	        return value, nil
	} else {
		return nil, nil
	}
...
func serialize_option_map_Symbol_to_Term(value *map[Symbol]Term, serializer serde.Serializer) error {
	if value != nil {
		if err := serializer.SerializeOptionTag(true); err != nil { return err }
		if err := serialize_map_Symbol_to_Term((*value), serializer); err != nil { return err }
	} else {
		if err := serializer.SerializeOptionTag(false); err != nil { return err }
	}
	return nil
...
func deserialize_option_map_Symbol_to_Term(deserializer serde.Deserializer) (*map[Symbol]Term, error) {
	tag, err := deserializer.DeserializeOptionTag()
	if err != nil { return nil, err }
	if tag {
		value := new(map[Symbol]Term)
		if val, err := deserialize_map_Symbol_to_Term(deserializer); err == nil { *value = val } else { return nil, err }
	        return value, nil
	} else {
		return nil, nil
	}
...
func serialize_option_vector_Term(value *[]Term, serializer serde.Serializer) error {
	if value != nil {
		if err := serializer.SerializeOptionTag(true); err != nil { return err }
		if err := serialize_vector_Term((*value), serializer); err != nil { return err }
	} else {
		if err := serializer.SerializeOptionTag(false); err != nil { return err }
	}
	return nil
...
func deserialize_option_vector_Term(deserializer serde.Deserializer) (*[]Term, error) {
	tag, err := deserializer.DeserializeOptionTag()
	if err != nil { return nil, err }
	if tag {
		value := new([]Term)
		if val, err := deserialize_vector_Term(deserializer); err == nil { *value = val } else { return nil, err }
	        return value, nil
	} else {
		return nil, nil
	}
...
func deserialize_vector_Operation(deserializer serde.Deserializer) ([]Operation, error) {
	...
	for i := range(obj) {
		if val, err := DeserializeOperation(deserializer); err == nil { obj[i] = val } else { return nil, err }
	}
	return obj, nil
}
...
func deserialize_vector_Parameter(deserializer serde.Deserializer) ([]Parameter, error) {
	...
	for i := range(obj) {
		if val, err := DeserializeParameter(deserializer); err == nil { obj[i] = val } else { return nil, err }
	}
	return obj, nil
}

func serialize_vector_Term(value []Term, serializer serde.Serializer) error {
	if err := serializer.SerializeLen(uint64(len(value))); err != nil { return err }
	for _, item := range(value) {
		if err := item.Serialize(serializer); err != nil { return err }
	}
...
func deserialize_vector_Term(deserializer serde.Deserializer) ([]Term, error) {
	length, err := deserializer.DeserializeLen()
	if err != nil { return nil, err }
	obj := make([]Term, length)
	for i := range(obj) {
		if val, err := DeserializeTerm(deserializer); err == nil { obj[i] = val } else { return nil, err }
	}
	return obj, nil
}
...
func deserialize_vector_Trace(deserializer serde.Deserializer) ([]Trace, error) {
	...
	for i := range(obj) {
		if val, err := DeserializeTrace(deserializer); err == nil { obj[i] = val } else { return nil, err }
	}
	return obj, nil
}
