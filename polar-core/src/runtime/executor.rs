...
use crate::{
    async_vm::AsyncVm, error::PolarResult, events::QueryEvent, kb::KnowledgeBase,
    messages::Message, runtime::Host, terms::Term, vm::PolarVirtualMachine,
};
...
impl LocalExecutor {
    pub fn new(vm: PolarVirtualMachine) -> Self {
        ...
        Self {
            ...
            host,
            run_spawned: false,
            runtime: smol::LocalExecutor::new(),
            done: false,
            last_event_vm: false,
        }
    }
