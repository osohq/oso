...
class AuthorizedSQLAlchemy(SQLAlchemy):
    ...
    :param get_actions: Callable that returns the actions to authorize for the current request.
    ...
    ...    get_actions=lambda: flask.request.method
    ... )

    .. _flask_sqlalchemy: https://flask-sqlalchemy.palletsprojects.com/en/2.x/
    """

    def __init__(self, get_oso, get_user, get_actions, **kwargs):
