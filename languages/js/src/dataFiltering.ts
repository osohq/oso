...
async function parseConstraint(host: Host, constraint: any): Promise<Constraint> {
...
function groundConstraints(host: Host, results: any, plan: any, constraints: any): any {
