...
typedef struct polar_HostSpan polar_HostSpan;

typedef struct polar_Polar polar_Polar;

typedef struct polar_Query polar_Query;

struct polar_HostSpan *polar_host_span_begin(const char *msg, const char *text);

int32_t polar_host_span_end(struct polar_HostSpan *span);
