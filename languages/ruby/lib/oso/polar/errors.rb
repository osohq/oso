...
module Oso
  module Polar
    ...
    class PolarFileAlreadyLoadedError < PolarRuntimeError; end
    class PolarFileContentsChangedError < PolarRuntimeError; end
    class PolarFileNameChangedError < PolarRuntimeError; end
