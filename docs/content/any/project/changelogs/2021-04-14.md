...
- `RegisterClass()` and `RegisterClassWithName()` now accept an instance of the
  to-be-registered Go type instead of a `reflect.Type` instance. Thanks
  to [`@decilb`](https://github.com/delicb) for this
  [contribution](https://github.com/osohq/oso/pull/820)!
