.. title:: 0.3.0 Changelog
.. meta::
  :description: Check out our changelog for oso 0.3.0 to learn about new features, bug fixes, and more. 
...
Some runtime errors will now return a trace of the policy location where it happened.
For example:
