...
.. note::
    ...
    The names of the relationships we add to models are generated by the following conventions:
...
The library also provides :py:data:`helper methods<sqlalchemy_oso.roles>` for
